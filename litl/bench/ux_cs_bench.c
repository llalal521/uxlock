...
void *thread_routine_transparent(void *arg)
{
    ...
    if(tid < ux_short_num)
        cri_len = 0;
    else if(tid < ux_short_num + ux_middle_num)
        cri_len = 1;
    else if(tid < (ux_short_num + ux_middle_num + ux_long_num))
        cri_len = 2;
    else
        cri_len = 2;
...
int main(int argc, char *argv[])
{
    ...
    long_number_of_shared_variables = 3200;
    middle_number_of_shared_variables = 1600;
