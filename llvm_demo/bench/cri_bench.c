...
lock_transparent_mutex_t *lockA;
...
int main(int argc, char *argv[])
{
    ...
    // for (int i = 0; i < CRI_LONG_TYPE; i++)
    // {
    //     number_of_shared_variables[i] = cri_len;
    //     shared_variables_memory_area[i] =
    //         (uint64_t *)malloc(number_of_shared_variables[i] * 64);
    //     cri_len *= 2;
    // }
